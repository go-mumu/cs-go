...
type Wxuser struct {
	...
	Longtime          *time.Time `gorm:"column:longtime;type:datetime;not null;default:0000-01-01 00:00:00;comment:邀请时间" json:"longtime"`                                // 邀请时间
	...
	Viptime           *time.Time `gorm:"column:viptime;type:datetime;not null;default:0000-01-01 00:00:00;comment:成为vip时间" json:"viptime"`                               // 成为vip时间
	Vipvalidity       *time.Time `gorm:"column:vipvalidity;type:datetime;not null;default:0000-01-01 00:00:00;comment:vip有效时间" json:"vipvalidity"`                       // vip有效时间
	Createtime        *time.Time `gorm:"column:createtime;type:datetime;not null;default:0000-01-01 00:00:00;comment:添加时间" json:"createtime"`                            // 添加时间
	...
	SubChannelTime    *time.Time `gorm:"column:sub_channel_time;type:datetime;not null;default:0000-01-01 00:00:00;comment:关注渠道修改时间" json:"sub_channel_time"`            // 关注渠道修改时间
	...
	XcxSubChannelTime *time.Time `gorm:"column:xcx_sub_channel_time;type:datetime;not null;default:0000-01-01 00:00:00;comment:小程序关注渠道修改时间" json:"xcx_sub_channel_time"` // 小程序关注渠道修改时间
